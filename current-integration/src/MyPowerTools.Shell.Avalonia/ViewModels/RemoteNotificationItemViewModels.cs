...
public sealed class RemoteNotificationLabelChipViewModel : ObservableViewModel
{
        ...
        Func<string?, Task> select)
    {
        ...
        _isUnread = isUnread;
        SelectCommand = new AsyncRelayCommand(() => select(FilterValue));
    }
...
public sealed class RemoteNotificationMessageViewModel : ObservableViewModel
{
