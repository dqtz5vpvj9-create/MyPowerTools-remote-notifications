...
public sealed record RemoteNotificationRecord(
    string Id,
    string Channel,
    string Message,
    string Icon,
...
public sealed record RemoteNotificationsSnapshot(
...
public sealed record RemoteNotificationPullResult(
    string State,
...
public interface IRemoteNotificationsStore
{
...
public interface IRemoteNotificationPoller
{
    Task<RemoteNotificationPullResult> PullAsync(string since, CancellationToken cancellationToken = default);
}

public sealed class RemoteNotificationNoopPoller : IRemoteNotificationPoller
{
